...
- Update #file:monafit-tracker/backend/monafit_tracker/views.py to replace the return for the rest api url endpiints with the codespace url http://vigilant-fishstick-x5wqp9p5ww7f4gp-8000.app.github.dev for django
- Replace <codespace-name> with vigilant-fishstick-x5wqp9p5ww7f4gp
...
@api_view(['GET'])
def api_root(request, format=None):
    base_url = 'http://vigilant-fishstick-x5wqp9p5ww7f4gp-8000.app.github.dev/'
    return Response({
        'users': base_url + 'api/users/?format=api',
        'teams': base_url + 'api/teams/?format=api',
        'activities': base_url + 'api/activities/?format=api',
